...
% Grid sizes
control.energy_length  = 100;
control.x_length       = 80;
control.mu_length      = 200;
control.max_algorithm_iterations = 150;
...
control.eps_min        = 1e-3;
control.eps_max        = 1.2 * control.eps_0;  % May be proportionate to control.eps_0
...
control.scale_x        = 5.2;
control.x_max          = 1e8/control.scale_x;
